...
public final class BankInterfaceGrpc {
  ...
  public static abstract class BankInterfaceImplBase implements io.grpc.BindableService {
    ...
    public void withdraw(proto.Bank.withdrawMessage request,
        io.grpc.stub.StreamObserver<proto.Bank.withdrawReply> responseObserver) throws SQLException {
    ...
    public void deposit(proto.Bank.depositMessage request,
        io.grpc.stub.StreamObserver<proto.Bank.depositReply> responseObserver) throws SQLException {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_WITHDRAW:
          try {
            serviceImpl.withdraw((Bank.withdrawMessage) request,
                (io.grpc.stub.StreamObserver<Bank.withdrawReply>) responseObserver);
        ...
        case METHODID_DEPOSIT:
          try {
            serviceImpl.deposit((Bank.depositMessage) request,
                (io.grpc.stub.StreamObserver<Bank.depositReply>) responseObserver);
          } catch (SQLException e) {
            throw new RuntimeException(e);
          }
          break;
